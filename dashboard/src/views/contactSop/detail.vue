  ...
  <div class="contact-sop-detail">
    <a-card>
      <div class="block">
        ...
        <div class="item">
          <span class="label required">使用成员：</span>
          <div class="input">
            <a-tag v-for="(member,i) in data.employees" :key="i">
              {{ member.name }}
            </a-tag>
          </div>
        </div>
...
<script>
import selectMember from '@/views/roomFission/components/create/selectMember'
import addRule from '@/views/contactSop/components/create/addRule'
import { getInfo } from '@/api/contactSop'
