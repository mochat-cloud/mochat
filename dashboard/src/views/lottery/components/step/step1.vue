  ...
  <div class="set">
    ...
    <div class="content">
      ...
      <div class="activity-name mt16 required">
        ...
        <a-input placeholder="请输入活动名称" style="width: 200px" v-model="form.name"/>
      </div>
      ...
      <div class="end">
        ...
        <div>
          <a-radio-group name="radioGroup" :default-value="1" v-model="form.time_type">
            <a-radio :value="1">
              永久有效
            </a-radio>
            <a-radio :value="2">
    ...
    <div class="customer-label">
      <div class="title mt30">
        ...
        <a-switch size="small" default-checked class="ml4" v-model="tagSet"/>
          ...
          <div class="label-rule">
            <div class="label-box">
              ...
              <div class="label-top mt8">
                <div v-for="(v,i) in form.tagList" :key="i" class="mb8 mb16 label-tag">
                  <div class="tag">
                    <a-icon type="minus-circle" class="mr6" @click="delTag"/>
                    为
                    <a-select style="width: 140px" default-value="请选择用户行为" v-model="v.action" :disabled="form.tagList.length==2">
...
export default {
  ...
  methods: {
    ...
    delTagsArr (index, idx) {
      this.form.tagList[this.selectInputIndex].clientTagArr.splice(idx, 1)
      this.form.tagList[this.selectInputIndex].tags.splice(idx, 1)
    },
    getParams () {
      return {
        name: this.form.name,
    ...
    showModal (index) {
      ...
      this.$refs.childRef.show(this.form.tagList[this.selectInputIndex].clientTagArr)
    },
    // 删除规则
    delTag (i) {
    ...
    // 添加规则
    addTag () {
      if (this.form.tagList.length === 2) {
        this.$message.error('不能添加2个以上')
