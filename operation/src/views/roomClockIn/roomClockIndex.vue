  ...
  <div class="page">
    ...
    <div class="days-box-bottom">
      <div class="customer-profile">
        ...
        <div class="task">
          <div class="task-box" v-for="(item,index) in clientclockIn.tasks" :key="index" @click="lookDetails(item,index)">
...
import {userInfo, contactDataApi,clockInRankingApi,contactClockInApi,receiveApi} from "@/api/roomClockIn";
export default {
  components: {
    roomClockInExplain,
    success
