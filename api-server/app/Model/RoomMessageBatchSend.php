...
class RoomMessageBatchSend extends AbstractModel
{
     ...
     * @var array
     */
    protected $fillable = ['id', 'corp_id', 'user_id', 'user_name', 'batch_title', 'content', 'send_way', 'definite_time', 'send_time', 'send_employee_total', 'send_room_total', 'send_total', 'not_send_total', 'received_total', 'not_received_total', 'send_status', 'created_at', 'updated_at', 'deleted_at'];
    /**
