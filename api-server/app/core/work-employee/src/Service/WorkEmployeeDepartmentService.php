...
use MoChat\App\WorkEmployee\Model\WorkEmployeeDepartment;
use MoChat\Framework\Service\AbstractService;

class WorkEmployeeDepartmentService extends AbstractService implements WorkEmployeeDepartmentContract
{
    /**
