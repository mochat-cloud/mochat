 ...
 */
namespace MoChat\App\WorkRoom\QueueService;
...
use MoChat\App\WorkRoom\Logic\WxSyncLogic;
                ...
                if ($groupChatList['errcode'] != 0) {
                    ...
                    if (isset($groupChatList[$wxResponse['ChatId']])) {
                        ...
                        if (isset($corpInfo['id'])) {
                            make(WxSyncLogic::class)->handle([$groupChat['group_chat']], (int) $corpInfo['id'], 1);
                        }
                    }
                }
            }
