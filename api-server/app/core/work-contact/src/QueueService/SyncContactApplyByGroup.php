...
use MoChat\App\WorkContact\Logic\SyncContactLogic;

/**
 * 分组同步单一成员跟进客户信息
 * Class SyncContactApplyByGroup.
 */
class SyncContactApplyByGroup
{
    use AppTrait;
    ...
    public function handle(array $employee, int $corpId, string $wxCorpid, array $wxContactIds): void
    {
        ...
        (new SyncContactLogic())->handle($employee, $corpId, $wxContactIds, array_filter($wxContactDetails));
    }
