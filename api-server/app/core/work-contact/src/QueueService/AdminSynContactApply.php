...
use MoChat\App\WorkContact\Logic\AdminSyncContactLogic;

/**
 * 同步多个成员的客户
 * Class AdminSynContactApply.
 */
class AdminSynContactApply
{
    use AppTrait;
    ...
    public function handle($employee, $corpId): void
    {
        ...
        ## 获取企业微信信息
        $this->corp = make(CorpContract::class)->getCorpById($corpId, ['id', 'wx_corpid']);
        ...
        //同步客户
        make(AdminSyncContactLogic::class)->handle($params);
    }
