...
class AddWay extends AbstractConstants
{
     ...
     * @Message("其他渠道")
     */
    public const OTHER_CHANNELS = 0;

    /**
     * @Message("扫描二维码")
     */
    public const SCAN_QR_CODE = 1;

    /**
     * @Message("搜索手机号")
     */
    public const SEARCH_MOBILE_PHONE = 2;

    /**
     * @Message("名片分享")
     */
    public const BUSINESS_CARD_SHARING = 3;

    /**
     * @Message("群聊")
     */
    public const GROUP_CHAT = 4;

    /**
     * @Message("手机通讯录")
     */
    public const MOBILE_PHONE_ADDRESS_BOOK = 5;

    /**
     * @Message("微信联系人")
     */
    public const WE_CHAT_CONTACT = 6;

    /**
     * @Message("来自微信的添加好友申请")
     */
    public const ADD_FRIEND_FROM_WE_CHAT = 7;

    /**
     * @Message("安装第三方应用时自动添加的客服人员")
     */
    public const CUSTOMER_SERVICE = 8;

    /**
     * @Message("搜索邮箱")
     */
    public const SEARCH_EMAIL = 9;

    /**
     * @Message("内部成员共享")
     */
    public const IN_MEMBER_SHARE = 201;

    /**
     * @Message("管理员/负责人分配")
     */
    public const ADMIN_ASSIGNMENT = 202;

    /**
     * @Message("渠道活码")
     */
    public const CHANNEL_CODE = 1001;

    /**
     * @Message("自动拉群")
     */
    public const AUTO_GROUP = 1002;

    /**
     * @Message("裂变引流")
     */
    public const FISSION_DRAINAGE = 1003;
