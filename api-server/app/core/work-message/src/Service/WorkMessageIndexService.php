...
use MoChat\App\WorkMessage\Model\WorkMessageIndex;
use MoChat\Framework\Service\AbstractService;

class WorkMessageIndexService extends AbstractService implements WorkMessageIndexContract
{
    /**
     * @var WorkMessageIndex
     */
    protected $model;
    ...
    {
        return $this->model::query()->whereIn('flag', $flag)->get($columns)->toArray();
    }
    ...
    {
        return $this->model::query()->where('corp_id', $corpId)->distinct()->get($columns)->toArray();
    }
}
