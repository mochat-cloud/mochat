...
class WeWorkCallback extends AbstractAction
{
    ...
    /**
     * @RequestMapping(path="/dashboard/corp/weWorkCallback", methods="get,post")
     */
    ...
    private function reloadRequest(): void
    {
        ...
        $corData = $this->container->get(CorpContract::class)->getCorpById($corId, ['id', 'wx_corpid']);
        if (empty($corData)) {
            return;
        }
