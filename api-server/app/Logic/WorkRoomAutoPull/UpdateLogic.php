...
class UpdateLogic
{
    ...
    public function handle(array $params): array
    {
        ...
        ## 获取自动拉群信息
        $workRoomAutoPull = $this->workRoomAutoPullService->getWorkRoomAutoPullById($workRoomAutoPullId, ['corp_id']);
        ...
        (new QrCodeUpdateApply())->handle((int) $workRoomAutoPull['corpId'], (int) $workRoomAutoPullId, array_column($employeeList, 'wxUserId'), $skipVerify);
