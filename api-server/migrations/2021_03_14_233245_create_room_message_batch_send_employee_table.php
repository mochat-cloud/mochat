...
class CreateRoomMessageBatchSendEmployeeTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('room_message_batch_send_employee', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('send_room_total')->default(0)->comment('发送群数量');
    ...
    {
        Schema::dropIfExists('room_message_batch_send_employee');
    }
}
