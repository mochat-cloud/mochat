...
CREATE TABLE IF NOT EXISTS `mc_auto_tag`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名称',
  `employees` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '生效成员（关键词打标签，分时段打标签）',
  `fuzzy_match_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模糊匹配关键词',
  `exact_match_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '精准匹配关键词',
  `tag_rule` json NULL COMMENT '标签规则',
  `tags` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标签组',
...
CREATE TABLE IF NOT EXISTS `mc_auto_tag_record`  (
  ...
  `wx_external_userid` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户wx_external_userid',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '所属员工id(mc_work_employee.id)',
  `keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '触发关键词',
...
CREATE TABLE IF NOT EXISTS `mc_room_clock_in`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动名称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动说明',
  ...
  `start_time` varchar(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开始时间（为空永久有效，不为空自定义活动时间）',
  `end_time` varchar(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '结束时间',
  `employee_qrcode` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客服二维码（用户领奖）',
...
CREATE TABLE IF NOT EXISTS `mc_room_clock_in_contact`  (
  ...
  `union_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '微信union_id',
  `contact_id` int(11) NULL DEFAULT 0 COMMENT '客户id（mc_work_contact.id。不能匹配时为0）',
  `nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '昵称',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '头像',
  `employee_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业员工',
  `city` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '城市',
  `contact_clock_tags` json NULL COMMENT '客户标签',
...
CREATE TABLE IF NOT EXISTS `mc_room_clock_in_contact_record`  (
  ...
  `day` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '打卡时间',
  `type` tinyint(1) NOT NULL COMMENT '打卡类型（1：连续打卡，2：累计打卡）',
...
CREATE TABLE IF NOT EXISTS `mc_lottery`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动名称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动说明',
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动模板（roulette：转盘）',
  `time_type` tinyint(1) NOT NULL COMMENT '截止日期（1：永久有效，2，自定义活动时间）',
  `start_time` varchar(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开始时间（为空永久有效，不为空自定义活动时间）',
  `end_time` varchar(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '结束时间',
...
CREATE TABLE IF NOT EXISTS `mc_lottery_contact`  (
  ...
  `employee_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业员工',
  `city` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '城市',
  `source` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '来源',
...
CREATE TABLE IF NOT EXISTS `mc_lottery_contact_record`  (
  ...
  `prize_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '奖品名称',
  `receive_status` tinyint(1) NULL DEFAULT 0 COMMENT '领奖状态（0：未领取。1：已领取）',
  `receive_qr` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客服二维码链接',
  `receive_type` tinyint(1) NOT NULL COMMENT '兑奖方式（1：客服二维码，2：兑换码）',
  `receive_code` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '兑换码',
...
CREATE TABLE IF NOT EXISTS `mc_official_account`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `app_type` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `appid` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方平台 appid',
  `authorized_status` tinyint(1) NULL DEFAULT NULL COMMENT '授权状态（1：授权成功，2：更新授权，3：取消授权）',
  `authorizer_appid` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '公众号或小程序的 appid',
  `authorization_code` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '授权码，可用于获取授权信息',
  `pre_auth_code` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '预授权码\r\n预授权码',
  `head_img` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '头像',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '头像服务器地址',
  ...
  `nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业昵称',
  ...
  `original_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `func_info` json NULL COMMENT '[\r\n      {\r\n        \"funcscope_category\": {\r\n          \"id\": 1\r\n        }\r\n      },\r\n      {\r\n        \"funcscope_category\": {\r\n          \"id\": 2\r\n        }\r\n      }\r\n    ]',
  `principal_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '公众号所设置的微信号，可能为空',
  `qrcode_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码图片的 UR',
  `local_qrcode_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码图片的 UR(服务器地址）',
  `callback_suffix` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `callback_verified` tinyint(1) NULL DEFAULT NULL,
  `user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '原始id',
  `encoding_aes_key` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方平台消息加解密  Key',
  `notify_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `secret` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方平台appserect',
  `token` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方平台token',
...
CREATE TABLE IF NOT EXISTS `mc_radar`  (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '雷达标题',
  `link` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '雷达链接',
  `link_title` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接标题',
  `link_description` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接摘要',
  `link_cover` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接封面',
  `pdf_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'PDF名称',
  `pdf` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '雷达PDF',
...
CREATE TABLE IF NOT EXISTS `mc_radar_channel`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '渠道名称',
  `tenant_id` int(11) NULL DEFAULT NULL COMMENT '租户id',
  `corp_id` int(11) NULL DEFAULT NULL COMMENT '企业id',
  `create_user_id` int(11) NULL DEFAULT NULL COMMENT '创建人ID',
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mc_radar_channel_link`  (
  ...
  `link` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '渠道链接',
...
CREATE TABLE IF NOT EXISTS `mc_radar_record`  (
  ...
  `union_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户union_id',
  `nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '昵称',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '头像',
  `contact_id` int(11) NULL DEFAULT NULL COMMENT '客户id',
  `employee_id` int(11) NOT NULL COMMENT '企业员工id',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '内容',
...
CREATE TABLE IF NOT EXISTS `mc_room_calendar`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '日历名称',
...
CREATE TABLE IF NOT EXISTS `mc_room_calendar_push`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `room_calendar_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '群日历id',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推送内容名称',
  `day` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推送时间',
...
CREATE TABLE IF NOT EXISTS `mc_room_calendar_record`  (
  ...
  `push_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '推送消息ids',
  `day` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推送时间',
  `room_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '群聊id',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_room_fission`  (
  ...
  `active_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '活动名称',
...
CREATE TABLE IF NOT EXISTS `mc_room_fission_contact`  (
  ...
  `union_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户微信id',
  `nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户微信昵称',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户微信头像',
  `parent_union_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '上级（被谁邀请来的）',
  `level` tinyint(1) NULL DEFAULT 0 COMMENT '裂变等级',
  `contact_id` int(11) NOT NULL DEFAULT 0 COMMENT '客户ID',
  `employee` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '添加的员工',
  ...
  `external_user_id` varchar(55) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '外部联系人external_userid',
...
CREATE TABLE IF NOT EXISTS `mc_room_fission_invite`  (
  ...
  `link_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '邀请链接描述',
  `link_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '邀请链接封面图',
  `wx_link_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '微信图片地址',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_room_fission_poster`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `fission_id` int(11) NOT NULL DEFAULT 0 COMMENT '活动ID',
  `cover_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '海报背景图片',
  ...
  `nickname_color` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '颜色',
  `qrcode_w` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码宽度',
  `qrcode_h` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码高度',
  `qrcode_x` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码X值',
  `qrcode_y` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码Y值',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_room_fission_room`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `fission_id` int(11) NOT NULL DEFAULT 0 COMMENT '活动ID',
  `room_qrcode` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '群聊二维码',
  `room_wx_qrcode` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '群聊二维码微信图片地址',
...
CREATE TABLE IF NOT EXISTS `mc_room_fission_welcome`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `fission_id` int(11) NOT NULL DEFAULT 0 COMMENT '活动ID',
  `text` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '文字欢迎语',
  `link_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接标题',
  `link_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接描述',
  `link_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接封面地址',
  `link_wx_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '微信图片地址',
  `template_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '欢迎语素材id',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_room_infinite`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '名称',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '二维码头像',
  `title_status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '群名称设置（0：关闭，1：开启）',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '群名称',
  `describe_status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '入群引导语（0：关闭，1：开启）',
  `describe` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '入群引导语',
  `logo` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '头像',
...
CREATE TABLE IF NOT EXISTS `mc_room_quality`  (
  ...
  `keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关键词',
...
CREATE TABLE IF NOT EXISTS `mc_room_tag_pull`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务名称',
  `employees` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '群发员工',
  `choose_contact` json NULL COMMENT '筛选客户条件',
  `guide` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '入群引导语',
  `rooms` json NULL COMMENT '群聊',
...
CREATE TABLE IF NOT EXISTS `mc_room_tag_pull_contact`  (
  ...
  `wx_external_userid` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户wx_external_userid',
  `contact_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户名称',
  `employee_id` int(11) NOT NULL COMMENT '员工id',
  `wx_user_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '员工wx_user_id',
...
CREATE TABLE IF NOT EXISTS `mc_shop_code`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '名称',
  ...
  `search_keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '搜索关键词',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地址',
  `country` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '国家',
  `province` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '省',
  `city` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '城市',
  `district` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地区',
  `lat` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地址纬度',
  `lng` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地址经度',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态（0：关闭，1：开启）',
  `tenant_id` int(11) NULL DEFAULT NULL COMMENT '租户id',
  `corp_id` int(11) NULL DEFAULT NULL COMMENT '企业id',
  `create_user_id` int(11) NULL DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE IF NOT EXISTS `mc_shop_code_page`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` tinyint(1) NOT NULL COMMENT '类型（1：扫码添加店主。2：扫码加入门店群。3：扫码加入城市群）',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '页面标题',
  ...
  `poster` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '自定义海报',
...
CREATE TABLE IF NOT EXISTS `mc_work_fission_contact`  (
  ...
  `is_new` tinyint(1) NOT NULL DEFAULT 0 COMMENT '新客户（0：老，1：新）',
  `external_user_id` varchar(55) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '外部联系人external_userid',
  `qrcode_id` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码ID',
  `qrcode_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码图片链接',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_work_fission_poster`  (
  ...
  `cover_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '海报背景图片',
  `wx_cover_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '背景图片微信地址',
  `foward_text` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '海报转发话术',
  `avatar_show` tinyint(1) NULL DEFAULT NULL COMMENT '头像是否显示。0：不显示，1：显示',
  `nickname_show` tinyint(1) NULL DEFAULT NULL COMMENT '昵称是否显示。0：不显示，1：显示',
  `nickname_color` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '颜色',
  `card_corp_image_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '个人名片企业形象名称',
  `card_corp_name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '个人名片企业名称',
  `card_corp_logo` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '个人名片企业logo',
  `qrcode_w` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码宽度',
  `qrcode_h` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码高度',
  `qrcode_x` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码X值',
  `qrcode_y` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '二维码Y值',
...
CREATE TABLE IF NOT EXISTS `mc_work_fission_push`  (
  ...
  `msg_text` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '消息1（文字）',
  `msg_complex` json NULL COMMENT '消息2（图片、链接、小程序）',
  `msg_complex_type` varchar(55) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '消息2类型（image|link|applets）',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_work_fission_welcome`  (
  ...
  `link_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接标题',
  `link_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接描述',
  `link_cover_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接封面地址',
  `link_wx_url` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '微信图片地址',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `mc_contact_sop`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '规则名称',
  `setting` text CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL COMMENT '推送内容（json）',
  `employee_ids` text CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL COMMENT '客服成员id（json）',
  `state` tinyint(1) NULL DEFAULT NULL COMMENT '开关：0关 1开',
  `contact_ids` text CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL COMMENT '触发的客户id（json）',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `mc_room_sop`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '规则名称',
  `setting` text CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL COMMENT '推送内容（json）',
  `room_ids` text CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL COMMENT '群聊id（json）',
  `state` tinyint(1) NULL DEFAULT NULL COMMENT '开关：0关 1开',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `mc_work_transfer_log`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户/群聊 名称',
  `contact_id` varchar(100) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户/群聊 WxId',
  `handover_employee_id` varchar(100) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '原客服的WxId',
  `takeover_employee_id` varchar(100) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '接替的客服的WxId',
...
CREATE TABLE IF NOT EXISTS `mc_room_welcome_template` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='入群欢迎语表';
...
CREATE TABLE IF NOT EXISTS `mc_work_unassigned` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='离职成员-客户存储表';
...
INSERT INTO `mc_rbac_menu` (`id`, `parent_id`, `name`, `level`, `path`, `icon`, `status`, `link_type`, `is_page_menu`, `link_url`, `data_permission`, `operate_id`, `operate_name`, `sort`, `created_at`, `updated_at`, `deleted_at`) VALUES ('297','276','详情','4','#1#-#275#-#276#-#297#','','1','1','1','/dashboard/groupCheck/show','2','0','系统','99','2021-06-10 16:09:49','2021-08-09 17:01:36',null);
...
INSERT INTO `mc_rbac_menu` (`id`, `parent_id`, `name`, `level`, `path`, `icon`, `status`, `link_type`, `is_page_menu`, `link_url`, `data_permission`, `operate_id`, `operate_name`, `sort`, `created_at`, `updated_at`, `deleted_at`) VALUES ('335','95','公众号授权','3','#1#-#95#-#335#','','3','1','1','/dashboard/officialAccount/index','2','0','系统','7','2021-07-12 10:51:13','2021-08-09 17:01:36',null);
