...
INSERT INTO `mc_rbac_menu` (`id`, `parent_id`, `name`, `level`, `path`, `icon`, `status`, `link_type`, `is_page_menu`, `link_url`, `data_permission`, `operate_id`, `operate_name`, `sort`, `created_at`, `updated_at`, `deleted_at`) VALUES ('585', '94', '套餐管理', '2', '#94#-#585#', 'shop', '1', '1', '1', 'path/1668673842', '1', '1', 'System', '99', '2022-11-17 16:30:42', '2023-03-22 22:46:32', null);
