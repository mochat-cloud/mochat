...
(
    ...
    name varchar(255) CHARACTER SET = utf8mb4mb4 COLLATE utf8mb4_unicode_ci  default '' not null comment '外部联系人姓名',
...
(
    ...
    contact_id int(11) unsigned default 0 not null comment '客户表ID（work_contact.id）',
    remark varchar(255) CHARACTER SET = utf8mb4mb4 COLLATE utf8mb4_unicode_ci  default '' not null comment '员工对此外部联系人的备注',
