...
use MoChat\Plugin\SensitiveWord\Model\SensitiveWordMonitor;

class SensitiveWordMonitorService extends AbstractService implements SensitiveWordMonitorContract
{
    /**
