...
use MoChat\Plugin\SensitiveWord\Model\SensitiveWordGroup;

class SensitiveWordGroupService extends AbstractService implements SensitiveWordGroupContract
{
    /**
     * @var SensitiveWordGroup
     */
    protected $model;
