...
/**
 * 自动打标签- 详情-客户入群打标签客户数据.
 *
 * Class ShowContactRoom.
 * @Controller
 */
class ShowContactRoom extends AbstractAction
{
    ...
    /**
     * @RequestMapping(path="/dashboard/autoTag/showContactRoom", methods="get")
     * @Middlewares({
    ...
    {
        ## 查询数据
        $res = $this->autoTagRecordService->getAutoTagRecordByRoomSearch($params);
        ## 组织响应数据
        $data = [
            'page' => [
