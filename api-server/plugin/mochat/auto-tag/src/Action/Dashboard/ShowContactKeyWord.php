 ...
 * @Controller
 */
class ShowContactKeyWord extends AbstractAction
{
    ...
    /**
     * @RequestMapping(path="/dashboard/autoTag/showContactKeyWord", methods="get")
     * @Middlewares({
    ...
    {
        ## 查询数据
        $res = $this->autoTagRecordService->getAutoTagRecordByKeyWordSearch($params);
        ## 组织响应数据
        $data = [
            'page' => [
