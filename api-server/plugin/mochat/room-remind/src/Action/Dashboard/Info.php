...
class Info extends AbstractAction
{
     ...
     * })
     * @RequestMapping(path="/dashboard/roomRemind/info", methods="get")
    ...
    public function handle(): array
    {
        ...
        ## 详情
        $info            = $this->roomRemindService->getRoomRemindById((int) $params['id'], ['name', 'rooms', 'is_qrcode', 'is_link', 'is_miniprogram', 'is_card', 'is_keyword', 'keyword', 'status']);
