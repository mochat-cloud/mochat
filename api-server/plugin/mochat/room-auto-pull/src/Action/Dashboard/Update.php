 ...
 */
namespace MoChat\Plugin\RoomAutoPull\Action\Dashboard;
...
use MoChat\Plugin\RoomAutoPull\Logic\UpdateLogic;
...
class Update extends AbstractAction
{
    ...
    /**
     * @RequestMapping(path="/dashboard/workRoomAutoPull/update", methods="put")
     * @Middlewares({
