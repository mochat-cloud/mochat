...
use MoChat\Plugin\ContactSop\Model\ContactSop;

class ContactSopService extends AbstractService implements ContactSopContract
{
    /**
     * @var ContactSop
     */
     ...
     * @return array 数组
     */
    public function getContactSopById(int $id, array $columns = ['*']): array
    {
     ...
     * @return array 数组
     */
    public function getContactSopsById(array $ids, array $columns = ['*']): array
    {
     ...
     */
    public function getContactSopList(array $where, array $columns = ['*'], array $options = []): array
    {
     ...
     * @return int 自增ID
     */
    public function createContactSop(array $data): int
    {
     ...
     * @return bool 执行结果
     */
    public function createContactSops(array $data): bool
    {
     ...
     * @return bool 执行结果
     */
    public function clearTableAndCreateContactSops(int $corpId, array $data): bool
    {
        //清除本企业保存的所有数据
        ...
        //新增数据
        return $this->createContactSops($data);
    }
     ...
     * @return int 修改条数
     */
    public function updateContactSopById(int $id, array $data): int
    {
     ...
     * @return int 删除条数
     */
    public function deleteContactSop(int $id): int
    {
     ...
     * @return int 删除条数
     */
    public function deleteContactSops(array $ids): int
    {
     ...
     * @return array 数组
     */
    public function getContactSopByCorpId(array $corpIds, array $columns = ['*']): array
    {
        $res = $this->model::query()
     ...
     * @return array 数组
     */
    public function getContactSopByCorpIdState(array $corpIds, int $state = 1, array $columns = ['*']): array
    {
        $res = $this->model::query()
            ->whereIn('corp_id', $corpIds)
            ->where('state', $state)
