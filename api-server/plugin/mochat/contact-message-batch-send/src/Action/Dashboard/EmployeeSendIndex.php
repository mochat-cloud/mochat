...
use MoChat\Plugin\ContactMessageBatchSend\Logic\EmployeeSendIndexLogic;
...
class EmployeeSendIndex extends AbstractAction
{
     ...
     * })
     * @RequestMapping(path="/dashboard/contactMessageBatchSend/employeeSendIndex", methods="GET")
     */
